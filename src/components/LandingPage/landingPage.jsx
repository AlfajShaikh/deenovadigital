...
export default function LandingPage() {
    ...
    return (
        <>
            ...
            <div className="bg-slate-50 min-h-screen text-slate-900 antialiased selection:bg-blue-500 selection:text-white scroll-smooth ">
                <section id="home">
                    <Banner />
                </section>
                    ...
                    <div className="mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex items-center justify-between h-16">
                            ...
                            <nav className="hidden md:flex items-center gap-10">
                                {["Home", "Services", "Consultation", "Clients", "Blogs"].map((item) => (
                                    <a
                                        key={item}
                        ...
                        <div
                            className={`md:hidden absolute left-0 w-full bg-white border-b border-gray-100 shadow-xl transition-all duration-300 ease-in-out ${menuOpen ? "top-full opacity-100 visible" : "top-[-200px] opacity-0 invisible"
                                }`}
                        >
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                            ...
                            <div className="bg-white p-8 rounded-2xl border border-slate-200/60 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                                ...
                                <p className="text-sm text-slate-500 leading-relaxed mb-4">
                                    Monolith transitions, scalable API frameworks, and optimized database systems built using JavaScript, React Vite, and TypeScript.
                                </p>
                            ...
                            <div className="bg-white p-8 rounded-2xl border border-slate-200/60 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                                ...
                                <p className="text-sm text-slate-500 leading-relaxed mb-4">
                                    Ultra-fast React.js interfaces paired with headless content platforms yielding high SEO performance scores.
                                </p>
                            ...
                            <div className="bg-white p-8 rounded-2xl border border-slate-200/60 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                                <div className="w-12 h-12 rounded-xl bg-pink-50 text-emerald-600 flex items-center justify-center font-bold mb-6 group-hover:bg-emerald-600 group-hover:text-green-600 transition-colors duration-300">
                                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <section id="consultation" className="py-20  bg-white overflow-hidden">
                        ...
                        <div className="flex items-center justify-center gap-4 mb-12">
                            {[1, 2, 3].map((step) => (
                                <div key={step} className="flex items-center gap-4">
                                    <div className={`w-8 h-8 rounded-full font-bold text-xs flex items-center justify-center transition-all duration-300 ${formStep >= step
                                    ...
                                    {step < 3 && (
                                        <div className={`h-1 w-12 rounded transition-colors duration-300 ${formStep > step ? "bg-blue-600" : "bg-slate-100"
                                            }`} />
                                    )}
                                </div>
                            ))}
                                            ...
                                            <div className="grid sm:grid-cols-2 gap-4">
                                                {[
                                                    ...
                                                    <button
                                                        ...
                                                        className={`p-4 text-left rounded-xl border-2 transition-all group ${formData.serviceType === srv.label
